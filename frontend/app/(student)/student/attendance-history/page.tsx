            ...
            <div className="max-w-[1200px] mx-auto">
                ...
                <div className="flex flex-row items-center md:items-start justify-between mb-8 gap-4">
                    ...
                    <div className="flex justify-end">
                        <button className="flex items-center justify-between border border-gray-200 rounded-md px-3 py-1.5 bg-white text-sm font-medium w-[130px] shadow-sm text-gray-700">
                ...
                {/* Summary Section */}
                <div className="mb-8">
                    <h2 className="text-[#C51A67] font-bold mb-4 text-[15px]">สรุปการลงเวลา (มกราคม)</h2>
